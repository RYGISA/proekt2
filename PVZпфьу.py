...
img_back = "1621357525_4-phonoteka_org-p-zadnii-fon-dlya-pikselnoi-igri-4.png" # фон гри
...
img_enemy = "pngwing.com-removebg-preview.png" # ворог
...
class Player(GameSprite):
    ...
    def update(self):
        ...
        if keys[K_RIGHT] and self.rect.x < 1170:
            self.rect.x += self.speed
...
# урок 3
# шрифти і написи
font1 = font.SysFont("Intro", 80)
win = font1.render('                 YOU WIN!', True, (50, 168, 82))
lose = font1.render('                YOU LOSE!', True, (180, 50, 50))
# додамо картинку куль
img_bullet = "pixil-frame-0.png" # куля
...
for i in range(1, 6):
    monster = Enemy(img_enemy, 900, win_height - 120, 100, 80, randint(1, 5))
